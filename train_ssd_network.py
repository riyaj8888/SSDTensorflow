...
DATASET_DIR='/content/SSD-Tensorflow-On-Custom-Dataset/tfrecords'
TRAIN_DIR='/content/SSD-Tensorflow-On-Custom-Dataset/VOC2007_/log/'
CHECKPOINT_PATH= '/content/SSD-Tensorflow-On-Custom-Dataset/checkpoints/ssd_300_vgg.ckpt/ssd_300_vgg.ckpt'
